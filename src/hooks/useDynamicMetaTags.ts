...
function useDynamicMetaTags(
  ...
  useEffect(() => {
    ...
    const defaultDescription = 'Red Steam is a clone of Steam. It is an educational project and not intended for profit.';
    ...
    $('meta[name="twitter:card"]')?.setAttribute('content', imageSrc || '/images/pwa-icon.png');
    ...
    $('meta[property="og:description"]')?.setAttribute('content', description || defaultDescription);
    $('meta[property="twitter:description"]')?.setAttribute('content', description || defaultDescription);
    $('meta[property="og:image"]')?.setAttribute('content', imageSrc || '/images/pwa-icon.png');
    $('meta[name="twitter:image"]')?.setAttribute('content', imageSrc || '/images/pwa-icon.png');
